...
In order to determine a hit with an attack, you simply make a resolution check against (your Weapon Skill with your equipped weapon + that weapon's Attack Bonus, if any) - (your target's Speed + your target's Armor Bonus on the targeted body region, if any). On any level of success, you have hit your target. For example, an attacker armed with a steel sword and with a Sword Skill rating of 3 attacks a target with Speed 4 and bronze armor. He checks against an adjusted rating of (3 [his Sword Skill] + 4 [his sword's Attack Bonus]) - (4 [his opponent's Speed + 1 [his opponent's armor bonus]), which equals 2. The player rolls a d100 and checks the resolution chart for a rating of 2.
