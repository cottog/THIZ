...
\rowcolor[HTML]{9B9B9B} 
\multicolumn{1}{|l|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}l@{}}Alchemy  $\beta$\\ Artifice $\alpha$\\ Druidism $\alpha$\\ Insight  $\beta$\\ Mentalism  $\beta$\\ Necromancy $\alpha$\\ Psychokinesis  $\beta$\\ Reiki $\alpha$\\ Shamanism  $\beta$\\ Summoning $\alpha$\end{tabular}}}                          & \multicolumn{1}{l|}{\cellcolor[HTML]{9B9B9B}\textbf{\begin{tabular}[c]{@{}l@{}}Animal Handling {[}M{]}\\ Fast Talk {[}M{]}\\ First Aid {[}M{]}\\ Magic Sense {[}P{]}\\ Navigation {[}M{]}\\ Perception {[}P{]}\\ Pilot (Choose One) {[}M{]}\\ Pocket-Picking {[}P{]}\\ Scrutiny {[}M{]}\\ Seduce {[}M{]}\\ Tracking {[}P{]} \\ Weather Sense {[}M{]}\end{tabular}}} \\ \hline
\end{tabular}
\end{table}
