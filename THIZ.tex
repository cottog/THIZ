...
A character can jump, tumble, or perform other acrobatic stunts by succeeding at a check against their Acrobatics skill or General Physical rating. 
...
\textbf{-9 to -5}    & 2 {[}25{]}     & 5 {[}50{]}    & /            & /               \\ \hline
\rowcolor[HTML]{EFEFEF} 
\textbf{-4 to -3}    & 2 {[}25{]}     & 5 {[}50{]}    & 10 {[}100{]} & /               \\ \hline
\rowcolor[HTML]{C0C0C0} 
\textbf{-2 to 0}     & 3 {[}35{]}     & 5 {[}50{]}    & 10 {[}100{]} & 15 {[}150{]}    \\ \hline
\rowcolor[HTML]{EFEFEF} 
\textbf{1 to 3}      & 3 {[}35{]}     & 5 {[}50{]}    & 15 {[}150{]} & 20 {[}250{]}    \\ \hline
\rowcolor[HTML]{C0C0C0} 
\textbf{4 to 6}      & 3 {[}35{]}     & 10 {[}100{]}  & 20 {[}250{]} & 25 {[}300{]}    \\ \hline
\rowcolor[HTML]{EFEFEF} 
\textbf{7 to 10}     & 3 {[}35{]}     & 10 {[}100{]}  & 20 {[}250{]} & 30 {[}350{]}    \\ \hline
\rowcolor[HTML]{C0C0C0} 
\textbf{11 to 13}    & 4 {[}50{]}     & 10 {[}100{]}  & 20 {[}250{]} & 35 {[}400{]}    \\ \hline
\rowcolor[HTML]{EFEFEF} 
\textbf{14 to 17}    & 4 {[}50{]}     & 10 {[}100{]}  & 20 {[}250{]} & 40 {[}500{]}    \\ \hline
\rowcolor[HTML]{C0C0C0} 
\textbf{22 to 25}    & 5 {[}60{]}     & 10 {[}100{]}  & 25 {[}300{]} & 50 {[}600{]}    \\ \hline
\rowcolor[HTML]{EFEFEF} 
\textbf{26 to 29}    & 5 {[}60{]}     & 15 {[}150{]}  & 25 {[}300{]} & 55 {[}650{]}    \\ \hline
\rowcolor[HTML]{C0C0C0} 
\textbf{30+}         & 5 {[}60{]}     & 15 {[}150{]}  & 30 {[}350{]} & 60 {[}700{]}    \\ \hline
\end{tabular}
}
\end{center}
...
A character may jog at the rate listed on the table above for a number of hours equal to either their Toughness or General Physical rating. A character with a value of zero in both of those ratings can jog for a single hour. After jogging for their maximum time, the character must rest for 1 hour. A character who has exceeded their maximum jogging time can no longer jog until they get 8 hours of sleep. 
